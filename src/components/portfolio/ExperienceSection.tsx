...
const experience = [
  {
    ...
    companyIcon: "rbb.png",
    description:
      "Delivered high-quality web projects and graphic designs. Also provided digital support.",
    technologies: ["Vite", "React", "JavaScript", "Node.js", "TailwindCSS"],
  },
  {
    role: "Founder",
    company: "Cyberspace Edge",
    period: "August 2024 — Present",
    type: "Part-Time",
    companyIcon: "ce.png",
    description:
      "Done product designing, web design & development, graphics design, and social media management here.",
    technologies: ["Framer", "Instagram", "Twitter/X"],
  },
  {
    role: "CEO",
    company: "AnM Studio",
    ...
    type: "Part-Time",
    companyIcon: "anm.png",
    description: "Manageing teams, and done graphic design projects.",
    technologies: ["Figma", "Instagram", "Facebook"],
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-6 md:gap-8 lg:gap-12">
                ...
                <div className="flex-shrink-0 flex flex-col items-center sm:items-start">
                  <motion.div
                    ...
                    className={`w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br flex items-center justify-center shadow-xl md:shadow-2xl mb-3 md:mb-4 relative overflow-hidden group-hover:shadow-2xl md:group-hover:shadow-3xl transition-all duration-500`}
                  >
                    <img
                      src={exp.companyIcon!}
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8 max-w-4xl mx-auto">
            <motion.div
