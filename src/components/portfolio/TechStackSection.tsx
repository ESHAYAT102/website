...
const techStackData: Record<string, TechItem[]> = {
  Backend: [
    ...
    },
    {
      ...
      description: "Hosting websites from GitHub repositories.",
      yearsUsed: 3,
    },
  ],
  Frontend: [
    ...
    },
    {
      ...
      level: "Expert",
      category: "Frontend",
      description: "Full-stack React scaffolding and bundling tool",
      yearsUsed: 2,
    },
    {
      name: "JavaScript",
  ...
  Others: [
    ...
    },
    {
      ...
      level: "Expert",
      category: "Others",
      description: "Design creation platform",
      yearsUsed: 6,
    },
    {
      name: "Notion",
      ...
      level: "Expert",
      category: "Others",
      description: "Notes taking and task management software",
      yearsUsed: 5,
    },
    {
      name: "Python",
    ...
    },
    {
      ...
      level: "Beginner",
      category: "Others",
      description: "Low level programming language developed by Google",
      yearsUsed: 1,
    },
  ],
};
